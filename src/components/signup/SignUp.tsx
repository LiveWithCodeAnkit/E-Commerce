...
export default function SignUp() {
  ...
  return (
    <>
      ...
      >
        <Form>
          <div className="w-96 p-6 space-y-6 bg-white shadow-md rounded-md">
            <h3 className="text-center font-semibold">Create New Account</h3>
            <div className="w-full">
              <div className="relative h-10 w-full min-w-[200px]">
                <Field
                  ...
                  placeholder=" "
                  // onBlur={(e:any) => {
                  //   e.currentTarget.Formik.setFieldTouched("name", true);
                  // }}
                />
